...
import { escapeHTML, icon, verdictTag } from "./shared.js";
...
export function render(state) {
  ...
  return `<section class="page-shell summary" aria-labelledby="view-title">
    ...
    <div class="recap-thread">${C.dialogue.map((turn, index) => recapTurn(turn, profile.dialogueAnswers[index], C.scenario)).join("")}</div>
