  ...
  return `<section class="page-shell" aria-labelledby="view-title">
    <div class="hero">
      <div>
        ...
        <div class="meta"><span>${escapeHTML(course.duration)}</span><span aria-hidden="true">•</span><span>${escapeHTML(course.level)}</span></div>
    ...
    <div class="section-heading"><div><h2>${escapeHTML(t("start.stagesTitle"))}</h2></div></div>
    <div class="card-grid">
